...
export function FooterSection() {
  return (
    <footer className="pt-24 pb-8 relative z-10 flex flex-col items-center overflow-hidden">
      ...
      <div className="w-[95%] bg-gradient-to-tr from-[#FDF0E1] via-[#F4EFFF] to-[#EBF0FE] border border-white shadow-[0_20px_50px_rgba(0,0,0,0.02)] px-6 sm:px-8 md:px-16 pt-12 sm:pt-16 pb-8 flex flex-col justify-between mx-auto rounded-[2.5rem]">
