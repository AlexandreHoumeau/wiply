...
export const TYPE_CONFIG: Record<string, { icon: LucideIcon; label: string; dot: string; chip: string }> = {
...
export const PRIORITY_CONFIG: Record<string, { icon: LucideIcon; label: string; color: string; badge: string }> = {
...
export const STATUS_CONFIG: Record<string, { icon: LucideIcon; label: string; color: string; dot: string }> = {
