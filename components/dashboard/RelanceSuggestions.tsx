...
export function RelanceSuggestions({ relances }: { relances: RelanceOpp[] }) {
  ...
  return (
    <div className="bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-800/40 rounded-2xl p-6 shadow-sm">
      <div className="flex items-center justify-between mb-5">
        ...
        <span className="text-xs font-bold text-amber-700 bg-amber-100 dark:bg-amber-900/40 px-2.5 py-1 rounded-full">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
        {relances.map((opp) => (
          <Link
            ...
            className="group flex items-start justify-between bg-card rounded-xl border border-amber-100 dark:border-amber-800/40 hover:border-amber-300 p-4 transition-all hover:shadow-sm"
          >
            <div className="min-w-0 flex-1">
              ...
              <div className="flex items-center gap-3 mt-2.5">
                ...
                <span className="text-xs text-muted-foreground">{timeAgo(opp.last_click_at)}</span>
              </div>
            </div>
